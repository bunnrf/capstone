      ...
      <div id="topbar">
        <div className="nav-container">
          <ul className="main-nav">
            ...
            <li className="menu-container"><a className="menu-icon" onFocus={ this.toggleMenuDisplay } onBlur={ this.toggleMenuDisplay } tabIndex="0"><div></div><div></div><div></div></a></li>
            <li className="upload-container"><div className="upload-button" onClick={ this.openModal }>upload images</div></li>
            <div className="menu-list" style={ this.state.menuOpen ? { display: "flex"} : { display: "none" } } onMouseDown={ e => e.preventDefault() }>
